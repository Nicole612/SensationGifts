...
try:
    # Import AI Engine Models
    from ai_engine.models import (
        # Sync Clients
        OpenAIClient, GroqClient, GeminiClient, AnthropicClient,
        # Async Clients  
        AsyncOpenAIClient, AsyncGroqClient, AsyncGeminiClient, AsyncAnthropicClient,
        # Factory & Intelligence
        AIModelFactory, get_ai_director, smart_gift_recommendation,
        # Enums & Types
        AIModelType, TaskPriority, UserContext,
        # Schemas
...
class QuickAIEngineTest:
    ...
    def generate_demo_summary(self):
        """
        Erstellt Demo-Summary für Mentor-Präsentation
        """
        print("\n" + "=" * 60)
