...
class EnhancedUser(EnhancedBase):
    """
    Enhanced User Model mit erweiterten Features
    ...
    # Relationships
    personality_profiles = sqlalchemy_relationship(
        "EnhancedPersonalityProfile", 
        back_populates="user", 
        cascade="all, delete-orphan"
    )
    recommendation_sessions = sqlalchemy_relationship(
        "EnhancedRecommendationSession", 
        back_populates="user", 
        cascade="all, delete-orphan"
    )
    user_activities = sqlalchemy_relationship(
    ...
    __table_args__ = (
        ...
        Index('idx_enhanced_user_last_activity', 'last_activity'),
    )
...
class EnhancedPersonalityProfile(EnhancedBase):
    """
    ...
    - Versioning Support
    """
    __tablename__ = 'enhanced_personality_profiles'
    
    # Primary Key
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    
    # User Reference
    user_id = Column(String(36), ForeignKey('enhanced_users.id'), nullable=False)
    ...
    # Relationships
    user = sqlalchemy_relationship("EnhancedUser", back_populates="personality_profiles")
    
    # Indexes
    __table_args__ = (
        Index('idx_enhanced_personality_user_id', 'user_id'),
        Index('idx_enhanced_personality_limbic_type', 'limbic_type_auto'),
        Index('idx_enhanced_personality_created_at', 'created_at'),
    )
...
class EnhancedGiftCategory(EnhancedBase):
    """
    Enhanced Gift Categories für Organisation
    """
    __tablename__ = 'enhanced_gift_categories'
    
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    name = Column(String(100), unique=True, nullable=False)
    description = Column(Text)
    parent_category_id = Column(String(36), ForeignKey('enhanced_gift_categories.id'))
    ...
    # Relationships
    parent_category = sqlalchemy_relationship("EnhancedGiftCategory", remote_side=[id])
    gifts = sqlalchemy_relationship("EnhancedGift", back_populates="category")
...
class EnhancedGift(EnhancedBase):
    """
    Enhanced Gift Database Model
    """
    __tablename__ = 'enhanced_gifts'
    ...
    # Classification
    category_id = Column(String(36), ForeignKey('enhanced_gift_categories.id'))
    ...
    # Relationships
    category = sqlalchemy_relationship("EnhancedGiftCategory", back_populates="gifts")
    
    # Indexes
    __table_args__ = (
        Index('idx_enhanced_gift_category_price', 'category_id', 'price'),
        Index('idx_enhanced_gift_popularity', 'popularity_score'),
        Index('idx_enhanced_gift_rating', 'rating'),
        Index('idx_enhanced_gift_available', 'is_available'),
    )
...
class EnhancedRecommendationSession(EnhancedBase):
    """
    Enhanced Recommendation Session Tracking
    """
    __tablename__ = 'enhanced_recommendation_sessions'
    ...
    # Relationships
    user = sqlalchemy_relationship("EnhancedUser", back_populates="recommendation_sessions")
    recommendations = sqlalchemy_relationship("EnhancedRecommendation", back_populates="session")
...
class EnhancedRecommendation(EnhancedBase):
    """
    Enhanced Individual Recommendation Results
    """
    __tablename__ = 'enhanced_recommendations'
    
    id = Column(String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    session_id = Column(String(36), ForeignKey('enhanced_recommendation_sessions.id'), nullable=False)
    ...
    # Relationships
    session = sqlalchemy_relationship("EnhancedRecommendationSession", back_populates="recommendations")
...
class EnhancedUserActivity(EnhancedBase):
    """
    Enhanced User Activity Tracking für Analytics
    """
    __tablename__ = 'enhanced_user_activities'
    ...
    # Relationships
    user = sqlalchemy_relationship("EnhancedUser", back_populates="user_activities")
    
    # Indexes
    __table_args__ = (
        Index('idx_enhanced_activity_user_type', 'user_id', 'activity_type'),
        Index('idx_enhanced_activity_created_at', 'created_at'),
    )
...
def create_enhanced_sample_data():
    """Create sample data for enhanced models"""
    
    # Sample User
    sample_user = EnhancedUser(
    ...
    sample_personality = EnhancedPersonalityProfile(
        user=sample_user,
        openness=4.2,
